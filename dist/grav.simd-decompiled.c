...
export function pAddForce(a:simd_ptr, b:simd_ptr) {
  a[2] = a[2] f32x4_add b[0]
}

export function pSubForce(a:simd_ptr, b:simd_ptr) {
...
export function pTick(a:{ a:simd, b:simd, c:simd, d:float }, b:float) {
